...
- This is for all the children I love ❤️ 
- Get an LLM to ask questions from life, and capture your answers here, by adding to the knowledge base below. it can also answer your "questions" from your notes below.

# Philosophy
### The Universe
The universe has underlying rules, but the permutations combinations from those rules are very high. 
one could argue that if we know the right starting conditions and available information/resources surroundimg the process, we could correctly guess the one event or process that followed, but that's almost impossible for mankind to find in our current state because the sheer volume of information needed tk be tracked, and potential loss of all traces of the conditions. sometimes the resulting processes themselves remove all traces of the starting conditions. Also, at microscopic level, Heisenberg's uncertainity principle kicks, so that's the smaller limit of our resolution. At universal scales, the universe is expanding faster than the speed of light, so that's the upper limit of our knowledge. 
...
Gap in understanding - how did they fight against entropy for the time being?
Gap in understanding - what is special about C,N,O and H that leads to carbon based life? are their compounds of a certain potential energy life that is just right for life or are they one of many possibilities, but the only one we know of? if they are one of many, what are the others?\
...
Gap in understanding - what is the mechanism behind pattern understanding and storing? Is it just chemical reactions balancing out?
Gap in understanding - how did we end up at and stay on DNA as well as its mutation as the means of keeping the chain going? Answering that helps to answer how evolution came about, as its the genetic response to changing environment for longevity.

everything life does is to keep the next generation - a concept that arises only in the context of reproduction - going. Not only does it reproduce, but does it's best to ensure the chain goes on. i.e. individual safety (safety is another concept that comes with the introduction of life) is optional, the overall likeness of the cells should continue. 
...
no. of offspring per event = f(strategy - cellular division, split of roles....egg-sperm external, egg-sperm internal...., f'(length of gestation period where egg is within the female)) 
surviving capacity / readiness per offspring = f(resources gathered before "being born"). This newborn survival rate is directly proportional to strategy

longevity = f(offensive strategies - where to get material and keep them, such that they will help cells stay alive and reproduce longer, defensive strategies - came about later when cells realized they could "draw out" offensive strategy material from other cells, and the "victim" cells realized they needed to protect themselves). Later we will see how these strategies define "survive" and "thrive".

### Indicators there is no God
No one can reproduce the same method to see / test God's presence. Seeing is just one way to perceive presence. E.g. We do not see black holes, but there is no limit to the number or type of people who can see one with their ___own eyes___ as long as they have the right equipment and knowledge. How is that different from the rituals and practices that religious people say can help . E.g. There are many who claim to have met the President of the country, but it is possible for them to take me there, as long as I meet the conditions (security clearance, travel to a location, waiting for time

### Then why does the vast majority believe in God
