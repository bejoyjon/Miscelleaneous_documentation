...
a.	optimizing RoI and standardizing technical footprint. 
b.	channeling investments for process, data, infra and application to support business forays into new product and customer categories.
c.	improving external and internal customer experience of Cargill's tech by reducing touchpoints and faster turnaround time.
...
3.	Control project inputs such as internal and external resourcing, sourcing, vendor contracting and billing as well as allocations such as Project capex vs opex. Leading project teams with a combined strength of over 35 Developers, 10 Business Analysts and Infra reviewers, 4 Data scientists and analysts and 4 Project Managers across SAP, related applications such as OpenText, MES applications, Generative AI applications and custom in-built applications. Dotted line reporting of Service Delivery Leads.
4.	Transform IT Operations experience by proactively identifying, prioritizing and remediating high impact issues through analytics driven Continuous Improvement programs.
5.	Product Management for Gen AI based solutions - build architectural framework, design and develop PoC, roadmap scaled solution, and secure funding for justified full scale products.

#### Experience / Achievements
1.	Built Generative AI solution for proactive service monitoring.
a.	Situation – Business colleagues in plants across Europe often face operational failures breaks and consequently raise tickets. However, no centralized view or analysis of issues across the Business Unit. This leads to escalations when multiple failures of the same nature happen across time or across locations. On the other hand, Ticket management teams focus on providing "quick fix" solutions rather than identifying a deeper root cause and propose longer term solutions. Manual root cause analysis takes months, often with shallow findings.
b.	Task – Proactively identify issue patterns through ETL methods and visualization. Classify issues, map to correct root cause based on previous issue resolution data. Initiate remediation post approval of all relevant Tech and Business leaders.
...
#### Role
Senior Consultant - Manufacturing Practice
#### Duration 
Jun 2016 - Oct 2019
#### Employer
...
d.	RoIC of 2.5X for $11Bn Fragrance & Flavors giant.
e.	Won client appreciation for increasing requirement gathering team efficiency by 25%.
...
#### Role
Senior Manager – Business Development (RE & Infra)
#### Duration 
Dec 2014 - Apr 2015 
#### Employer
...
### Jul 2009 - Nov 2014 - Bid Manager - Alstom Transport India Limited - Noida, India
#### Role
Bid Manager	
#### Duration 
Jul 2009 - Nov 2014
